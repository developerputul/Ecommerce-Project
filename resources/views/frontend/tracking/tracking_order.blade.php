...
<div class="container">
        ...
        <div class="card-body">
            ...
            <article class="card">
                <div class="card-body row">
                    ...
                    <div class="col">
                    <strong>Shipping BY:</strong> <br> {{ $track->name }}, | <i class="fa fa-phone">
                    </i> {{ $track->phone }} / {{ $track->division->division_name }} /
    ...
    <div class="track">
        ...
        <div class="step"> <span class="icon"> <i class="fa fa-user"></i> </span> <span class="text"> Order Confirm</span> </div>
