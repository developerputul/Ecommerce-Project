                    ...
                    <select name="category_id" class="form-select" id="inputVendor">
                        ...
                        @endforeach
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-9 text-secondary">
                                    <textarea name="post_short_desc" class="form-control" id="inputProductDescription"
                                     rows="3">

                               {{ $blogpost->post_short_desc }}
                                    </textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-9 text-secondary">
                                    <textarea name="post_long_desc" id="ck-editor" class="form-control text-editor" 
                                    style="height: 50vh">
                                
                                    {!! $blogpost->post_long_desc !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <img id="showImage" src="{{ asset($blogpost->post_image) }}" alt="Category" style="width:100px; height:100px;">
