                ...
                <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <br>
                            <img id="showImage" src="{{ (!empty($userData->photo)) ? url('upload/user_image/'. $userData->photo): url('upload/no_image.jpg')}}" alt="User" class="rounded-circle p-1 bg-primary" width="110">
                        </div>
                        <div class="card-body">
                            <p>
                            ...
                            <form method="post" action="{{ route('user.update.password') }}">
                                ...
                                @endif
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input class="form-control" name="new_password_confirmation" type="password" id="new_password_confirmation" placeholder="new Password Confirm"/>
                                     </div>
