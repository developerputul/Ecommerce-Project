        ...
        $.ajax({
            ...
            $.each(response.wishlist,function(key,value){
                rows += ` <tr class="pt-30">
                        ...
                        <td class="image product-thumbnail pt-40"><img src="${value.product.product_thumbnail}" alt="#" />
                            </td>
                ...
                rows += ` 
                        ...
                        <tr class="pr_title">
                            ...
                            <td class="product_name">
                                <h6><a href="shop-product-full.html" 
                                class="text-heading">${value.product.product_name}</a></h6>
                            </td>
                        </tr>
                        ...
                        <tr class="pr_stock">
                            ...
                            <td class="row_stock">
                                ${value.product.product_qty > 0
                                    ? `<span class="stock-status in-stock mb-0">In Stock</span></td>`
                                    : `<span class="stock-status out-stock mb-0">Stock Out</span></td>`
