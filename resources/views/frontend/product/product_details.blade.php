                        ...
                        <div class="tab-content shop_info_tab entry-main-content">
                            ...
                            <div class="tab-pane fade" id="Vendor-info">
                                ...
                                <ul class="contact-infor mb-50">
                                    <li><img src="{{ asset ('forntend/assets/imgs/theme/icons/icon-location.svg')}}" alt="" />
                                        <strong>Address: </strong> <span>Owner</span>
                                    </li>
                                    <li><img src="{{asset ('frontend/assets/imgs/theme/icons/icon-contact.svg')}}" alt="" />
                                        <strong>Contact Seller:</strong><span>Owner</span>
                                    </li>
                                </ul>
                                @else
                                <ul class="contact-infor mb-50">
                                    ...
                                    <li><img src="{{asset ('frontend/assets/imgs/theme/icons/icon-contact.svg')}}" alt="" />
                                        <strong>Contact Seller:</strong><span>{{ $product['vendor']['phone'] }}</span>
                                    </li>
                                </ul>
                                @endif
        ...
        <table class="table" style="width: 60%">
                ...
                <tbody>
                    <tr>
                        ...
                        <th><input type="radio" name="quality" class="radio-sm" value="1"></th>
                        <th><input type="radio" name="quality" class="radio-sm" value="2"></th>
                        <th><input type="radio" name="quality" class="radio-sm" value="3"></th>
                        <th><input type="radio" name="quality" class="radio-sm" value="4"></th>
                        <th><input type="radio" name="quality" class="radio-sm" value="5"></th>
                    </tr>
                </tbody>
        </table>
